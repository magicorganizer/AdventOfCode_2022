...
class Track:
    def __init__(self, track_name, height=chr(ord("a") - 1), pos=[0, 0], track=[]):
...
class Day12:
    ...
    def load_puzzle_input(self):
        self.commands.clear()
        filename = r"d:\Data\Advent Of Code 2022\GitHub\AdventOfCode_2022\map_for_day_12.txt"
    ...
    def print_tracks(self):
        ...
        if len(self.tracks) < 25:
            for idx, track in enumerate(self.tracks):
                print(idx, track)
            print(f"After round:{self.round_counter}")
